...
<div id="sidebar" class="sidenav sidenav-fixed expand-md">
  <div class="sidenav-header">
    <div class="font-26 font-weight-strong mt-2">
      <a href="${root}"><span class="logo">SolMusic</span></a>
    </div>
  </div> <!--logo END  -->
  ...
  <div class="divider"></div>
    ...
    <c:choose>
        ...
        <c:otherwise>
        <li>
          <A href='#' class="collapsible-header waves-effect" ><span class="fas fa-user-circle fa-lg" style="margin-right:10px;"> </span>${sessionScope.nickname}${sessionScope.adminID}<i class="material-icons rotate-icon">keyboard_arrow_down</i></A> 
    ...
    <div class="divider"></div>
      ...
      <li><a class="#" href="#"><i class="fas fa-home" style="margin-right:10px;"></i>투데이</a></li>
